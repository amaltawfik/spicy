...
one, and the gap grows with the between-subject variance. The full GEE
workflow — working-correlation choice via QIC, jackknife variants for
few clusters, event counts, population-averaged marginal effects, and
