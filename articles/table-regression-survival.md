...
model. Being female adds an average of **40.5 event-free days** over the
first year (95% CI 17 to 64) and lowers the one-year risk of death by
**19 percentage points** (95% CI 8 to 30); each additional ECOG point
...
HR 1.12 and about nine fewer event-free days. Rescale the predictor when
the per-unit contrast is not the meaningful one.
