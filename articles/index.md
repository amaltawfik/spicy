...
- [Categorical summary
  ...
  APA formatting by default, named journal styles (JAMA, NEJM, The
  Lancet, …) by argument.
...
- [Continuous summary
  ...
  and export to console, gt, tinytable, flextable, Excel, or Word — APA
  formatting by default, named journal styles (JAMA, NEJM, The Lancet,
  …) by argument.
...
- [Model-based continuous summary
  ...
  noncentral CIs, and journal-styled output (APA by default; JAMA, NEJM,
...
- [GEE regression tables (population-averaged
  models)](https://amaltawfik.github.io/spicy/articles/table-regression-gee.md):
