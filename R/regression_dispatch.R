...
as_structured <- function(x) {
  ...
  builders <- c(
    ...
    spicy_continuous_svy_table = "table_continuous_svy()",
    spicy_categorical_svy_table = "table_categorical_svy()"
  )
  ...
  since <- c(
    ...
    spicy_continuous_svy_table = "0.13.0",
    spicy_categorical_svy_table = "0.13.0"
  )
