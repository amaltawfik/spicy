...
## Regression tables by model family

What
[`table_regression()`](https://amaltawfik.github.io/spicy/reference/table_regression.md)
does for each supported model family: engines, inference,
robust-variance backends, exponentiate semantics, marginal effects, fit
statistics, and the family’s labelled blocks.
