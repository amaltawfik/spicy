...
al., 2024) and SPSS conventions. To recover the signed direction of the
2x2 association, compute the Pearson correlation directly (e.g.
`cor(x, y)` after coding both variables 0/1).
