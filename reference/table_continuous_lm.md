...
quietly = TRUE)) { tmp_xlsx \<-
[tempfile](https://rdrr.io/r/base/tempfile.html)(fileext = ".xlsx")
table_continuous_lm( sochealth, select =
[c](https://rdrr.io/r/base/c.html)(wellbeing_score, bmi), by = sex,
output = "excel", excel_path = tmp_xlsx )
[file.exists](https://rdrr.io/r/base/files.html)(tmp_xlsx)
[unlink](https://rdrr.io/r/base/unlink.html)(tmp_xlsx) } \# Word: write
to a temporary .docx. if (
[requireNamespace](https://rdrr.io/r/base/ns-load.html)("flextable",
quietly = TRUE) &&
[requireNamespace](https://rdrr.io/r/base/ns-load.html)("officer",
quietly = TRUE) ) { tmp_docx \<-
[tempfile](https://rdrr.io/r/base/tempfile.html)(fileext = ".docx")
table_continuous_lm( sochealth, select =
[c](https://rdrr.io/r/base/c.html)(wellbeing_score, bmi), by = sex,
output = "word", word_path = tmp_docx )
[file.exists](https://rdrr.io/r/base/files.html)(tmp_docx)
[unlink](https://rdrr.io/r/base/unlink.html)(tmp_docx) } \# }
