...
- See [*Categorical summary tables*](table-categorical.html) for grouped
  tables of categorical variables.
- See [*One outcome across several groupings*](table-outcome.html) for the
  transposed shape: ONE continuous outcome described across the
  levels of SEVERAL groupings, one block of rows per grouping.
  Several outcomes across one grouping is this article; one outcome
  across one or more groupings is that one.
- See [*Model-based continuous summary tables*](table-continuous-lm.html) for
  ...
  case weights.
- See [*Publication-ready regression tables*](table-regression.html) for full
