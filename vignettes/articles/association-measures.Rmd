...
article explains which measure to use depending on the measurement
...
smoking-by-education table from the beginning of the article:
...
- See [*Frequency tables and cross-tabulations*](frequency-tables.html) for `cross_tab()`, which reports
  these measures inline through its `assoc_measure` argument.
- See [*Categorical summary tables*](table-categorical.html) for association measures inside
