...
again disclosed in the note. Set `drop_na = FALSE` to display them
as a dedicated "(Missing)" group instead. The group-comparison test
and effect size still cover the observed groups only, matching
`table_categorical()`:
