...
interval with no weighted version), and the group tests — a *t*-test
printed next to weighted descriptives would itself be unweighted.
For weighted group comparisons, `table_continuous_lm()` takes the
same `weights` argument and fits them properly:
