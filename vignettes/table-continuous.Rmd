...
The SMD and Hedges' *g* look alike and are not the same number:
...
*g* divides by the degrees-of-freedom pooled SD and applies the *J*
correction. They coincide exactly when the two groups are the same
size and part company as soon as they are not. Read each for what it
is: the SMD is a balance diagnostic, *g* is an effect size. It also
follows that the SMD carries **no confidence interval and no
*p*-value** — attaching one would put back the test reasoning the
balance literature asks the reader to drop.
