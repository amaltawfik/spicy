...
journal's midline decimal point instead of the comma. Add
`p_style = "standard"` to put the zero back.

An argument you type wins over both, which is the escape hatch for a
bilingual table — French words, decimal point:
...
under `style = "jama"` or `decimal_mark = ","` the cited string
changes with the printed one. And the addressing survives relabeling:
