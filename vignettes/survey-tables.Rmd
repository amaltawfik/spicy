...
`degf(dstrat)` minus the non-intercept parameters, which is what survey
writes on the fit and what `survey::regTermTest()` takes as its
denominator -- not the design's own:
