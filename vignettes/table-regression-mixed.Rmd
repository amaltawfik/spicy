...
substantive one: simplify the random structure rather than report a
zero variance with invented uncertainty.
...
likelihood-ratio test (the same statistic as `lmerTest::ranova()`):
