...
`table_categorical()` builds a publication-ready cross-tabulation
report by crossing one grouping variable with one or many selected
variables. It supports multiple output formats.
