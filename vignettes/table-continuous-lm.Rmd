...
future spicy release alongside `table_regression()`. To fit a
fully-specified model right now, do so with `lm()` directly and
inspect via `summary()`, `broom::tidy()`, or `gtsummary`.
