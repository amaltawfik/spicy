...
- Extract variable metadata and display compact summaries of dataset
  ...
  of distinct non-missing values, number of valid observations, number
...
- Generate an interactive codebook generator
  ...
  for documenting all the variables present in a data frame.
...
![Summary of all variables shown in the
Viewer](reference/figures/varlist_1.png)
...
![Summary of the variables that start with d in the
Viewer](reference/figures/varlist_2.png)
...
citation](https://amaltawfik.github.io/spicy/inst/citation.bib)
directly.
