...
- **Design-based summary tables** with
  ...
  linearization or replicate weights), design degrees of freedom,
...
- **Journal styles** with
  ...
  `"aer"` restyles any table, every rule sourced from each style’s
  published guidelines. For a French table,
...
for
[`table_regression()`](https://amaltawfik.github.io/spicy/reference/table_regression.md)
across model families, and [Summary tables for
