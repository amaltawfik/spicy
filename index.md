...
- **Regression tables** with
  ...
  comparisons with the correct nested test per class, and
  ...
  ordinal models report their thresholds; zero-inflated and hurdle
  models report every model component.
