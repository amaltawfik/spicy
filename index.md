...
generated by `citation("spicy")` at build time, so it always matches the
released version):

Tawfik A (2026). *spicy: Descriptive Statistics, Summary Tables, and
Data Management Tools*. <doi:10.32614/CRAN.package.spicy>
<https://doi.org/10.32614/CRAN.package.spicy>. R package version
0.12.0.9000, <https://CRAN.R-project.org/package=spicy>.
