...
- Generate an exportable codebook using `code_book()`, which extends `varlist()` with support for CSV, Excel, PDF, and Word exports, either interactively (via `DT::datatable`) or programmatically. Ideal for documenting all variables present in a data frame
