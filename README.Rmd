...
- Generate an interactive codebook generator `code_book()` that extends `varlist()` with searchable summaries and built-in export options (Copy, CSV, Excel, PDF, Print) via `DT::datatable`. Ideal for documenting all the variables present in a data frame.
